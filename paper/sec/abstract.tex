...
The developed botnet is thought as an educational showcase, but nevertheless it can be used both for local testing and simulation of real web scenarios.
