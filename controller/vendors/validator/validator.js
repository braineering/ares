...
var validator = (function($){
    ...
    */
    message = {
        ...
        number_min      : 'input is too low',
        number_negative : 'input is negative',
        number_max      : 'input too high',
        url             : 'invalid URL',
        ip              : 'invail IP',
        number          : 'not a number',
    ...
    */
    tests = {
        ...
        ip : function(a){
            var ipformat = /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\:([0-9]?[0-9]?[0-9]?[0-9])$/;  
        ...
        number : function(a){
            ...
            //if is a negative number
                ...
                alertTxt = message.number_negative;
                return false;
            }
            // not enough numbers
